...
from scenario_pipeliner.api.settings import PluginManifestV1, RegistryRegisterResult
from scenario_pipeliner.core.checksum import sha256_directory, sha256_file
from scenario_pipeliner.core.exceptions import DryRunPluginError, RegistryError
...
class PluginRegistryV1:
    def __init__(self) -> None:
        ...
        self._schema_to_plugin: dict[str, str] = {}
        ...
        *,
        ...
        try:
            claim_plugin_identity(
                ...
                seen_names=self._plugin_names,
                schema_owners=self._schema_to_plugin,
            )
        except DryRunPluginError as exc:
